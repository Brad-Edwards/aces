...
| Crash-consistency tests from PR #1136 (115 tests) | adopt | Absorbed into CP-9's profile conformance suite with kill-point injection at every commit boundary of the new lifecycle. |
