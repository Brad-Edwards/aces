...
- Assurance report:
  `docs/raes/inventory/methodology-assurance-report.md`
- Agent workflow:
  `.codex-skills/raes-asset-inventory-capture/SKILL.md` and
  `.claude/skills/raes-asset-inventory-capture/SKILL.md`
...
- `.codex-skills/raes-asset-inventory-capture/scripts/normalize-syft-cyclonedx.jq`
