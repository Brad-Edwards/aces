...
- Prior asset patterns:
  ...
  `docs/raes/inventory/webapp-preflight.md`, and
  `tests/test_webapp_inventory.py`.
- RAES adoption and parity routing:
  downstream APTL ADR-035, `docs/raes/parity-inventory.yaml`,
  `docs/raes/parity-inventory.md`, and `tests/test_parity_inventory.py`.
