...
- IMPLEMENTS → GITHUB_ISSUE `RAESystem/rae#986` (Define portable external concept-scheme references and binding assertions)
...
- DOCUMENTS → GITHUB_ISSUE `RAESystem/rae#104` (External knowledge reference surface (DSL-114))
