...
- IMPLEMENTS → GITHUB_ISSUE `OpenRAE/rae#961` (Implement bounded participant-opacity profiles and falsification)
- IMPLEMENTS → GITHUB_ISSUE `OpenRAE/rae#962` (Model-check finite participant-opacity profiles)
