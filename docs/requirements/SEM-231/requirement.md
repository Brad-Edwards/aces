...
- DOCUMENTS → GITHUB_ISSUE `RAESystem/rae#961` (Implement bounded participant-opacity profiles and falsification)
- DOCUMENTS → GITHUB_ISSUE `RAESystem/rae#962` (Model-check finite participant-opacity profiles)
- DOCUMENTS → GITHUB_ISSUE `RAESystem/rae#965` (Declare and validate backend participant-opacity realization)
