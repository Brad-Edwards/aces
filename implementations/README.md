...
The current working implementation effort is under `implementations/python/`.
Additional implementation trees can be added here over time without changing
the normative repo layout.
