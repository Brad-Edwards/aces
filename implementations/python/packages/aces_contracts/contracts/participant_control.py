...
class ParticipantControlOccurrenceModel(ParticipantRuntimeBaseEnvelopeModel):
    ...
    def __get_pydantic_json_schema__(
        ...
        _add_aces_invariant(
            ...
            validator="aces_contracts.contracts.validate_participant_control_occurrence_context",
        ...
        _add_aces_invariant(
            ...
            validator="aces_contracts.contracts.ParticipantControlOccurrenceModel",
            inputs=[{"contract_id": "participant-control-occurrence-v1", "instance_path": "#"}],
        )
        return json_schema
