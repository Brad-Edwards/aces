...
Builds strictly within ``aces_contracts`` (ADR-036's portable DTO/profile-shape
bucket): selection/compilation (``aces_processor``) and live execution
(``aces_runtime``) are out of scope here (#787-#791). See
...
class StreamAddressModel(ContractModel):
    ...
    def __get_pydantic_json_schema__(
        ...
        _add_aces_invariant(
            ...
            validator="aces_contracts.contracts.random_stream.StreamAddressModel._validate_draw_purpose",
...
class RandomStreamProfileModel(ContractModel):
    ...
    def __get_pydantic_json_schema__(
        ...
        _add_aces_invariant(
            ...
            validator="aces_contracts.contracts.random_stream.RandomStreamProfileModel._validate_transform_keys",
...
class RandomStreamDrawRecordModel(ContractModel):
    ...
    def __get_pydantic_json_schema__(
        ...
        _add_aces_invariant(
            ...
            validator=(
                "aces_contracts.contracts.random_stream.RandomStreamDrawRecordModel."
