...
class TrialCleanupPlanModel(ContractModel):
    ...
    def __get_pydantic_json_schema__(cls, core_schema: CoreSchema, handler: GetJsonSchemaHandler) -> JsonSchemaValue:
        ...
        _add_aces_invariant(
            ...
            validator="aces_contracts.contracts.TrialCleanupPlanModel._validate_plan",
...
class TrialCleanupReceiptModel(ContractModel):
    ...
    def __get_pydantic_json_schema__(cls, core_schema: CoreSchema, handler: GetJsonSchemaHandler) -> JsonSchemaValue:
        ...
        _add_aces_invariant(
            ...
            validator="aces_contracts.contracts.validate_trial_cleanup_receipt",
            inputs=[
...
class SchedulerIsolationProofModel(ContractModel):
    ...
    def __get_pydantic_json_schema__(cls, core_schema: CoreSchema, handler: GetJsonSchemaHandler) -> JsonSchemaValue:
        ...
        _add_aces_invariant(
            ...
            validator="aces_contracts.contracts.SchedulerIsolationProofModel._validate_isolation",
