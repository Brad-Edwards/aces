...
:func:`aces_contracts.validation_profiles.select_validation_profile` -- never a
...
vocabulary live in :mod:`aces_contracts.contracts.validation_disclosure_gates`;
the subject/producer reference shapes live in
:mod:`aces_contracts.contracts.validation_subject_reference`. Both were split
...
if TYPE_CHECKING:
    # Deferred: aces_contracts.validation_profiles imports back from this
    # package (aces_contracts.contracts), so the runtime lookup happens
...
class ValidationBasisDisclosureModel(ContractModel):
    ...
    def __get_pydantic_json_schema__(
        ...
        validator = (
            "aces_contracts.contracts.validation_disclosure.ValidationBasisDisclosureModel."
            "_validate_validation_basis_disclosure"
        )
        inputs = [
            {"contract_id": "validation-basis-disclosure-v1", "instance_path": "#"},
            {"contract_id": "experiment-task-v1", "instance_path": "#/validation_basis_disclosures"},
            {"contract_id": "experiment-run-v1", "instance_path": "#/validation_basis_disclosures"},
            {"contract_id": "experiment-study-v1", "instance_path": "#/validation_basis_disclosures"},
        ]
