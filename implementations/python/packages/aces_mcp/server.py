...
real-world annotated scenarios. Use `sdl_validate`, `sdl_design_assessment`, \
`sdl_plan`, and `sdl_claims_assessment` to check SDL YAML and avoid \
overstating what a scenario or dry run can prove.\
"""
