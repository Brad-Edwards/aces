...
from raes_mcp.tools.operation_support import json_response

if TYPE_CHECKING:
    from raes_contracts.scientific_completeness import CompletenessProfileModel, ProfileCompletenessResult
