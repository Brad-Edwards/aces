...
| `historical_baselines.*.materialization_bindings.*.target_service_ref` | `targetable` | semantic validation | fatal unless a named VM service agreeing with the reset-owner target | [authored historical state](authored-historical-state.md) | [historical-state semantics](../../implementations/python/packages/aces_sdl/semantics/historical_state.py) |
...
| `historical_baselines.*.materialization_bindings.*.reset_owner_relationship_ref` | `relationships` | semantic validation | fatal dangling or baseline/target disagreement | [authored historical state](authored-historical-state.md) | [historical-state semantics](../../implementations/python/packages/aces_sdl/semantics/historical_state.py) |
