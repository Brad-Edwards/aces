...
| `activity_templates` | section | map | normalized, expanded, instantiated | optional; default empty map | `map_key` | none | [deterministic live activity](deterministic-live-activity.md) |
| `activity_profiles` | section | map | normalized, expanded, instantiated | optional; default empty map | `map_key` | catalogued | [deterministic live activity](deterministic-live-activity.md) |
...
<!-- sdl-catalog-summary top-level=42 metadata-composition=6 sections=36 maps=35 lists=1 -->
