...
- Added `aces libvirt techvault validate-live`, which boots the TechVault operational scenario through the ACES/libvirt provisioning path and verifies container readiness, Kali reachability, Wazuh telemetry, Suricata telemetry, SOC readback, and run-archive evidence.
